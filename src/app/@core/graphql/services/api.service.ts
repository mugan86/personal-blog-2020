...
import { getCourse, getPosts, login, mostImportantPostData,
          selectPost, getPortfolioData } from '@core/graphql/operations/query';
import { addMessage, uploadFile } from '@core/graphql/operations/mutation';
